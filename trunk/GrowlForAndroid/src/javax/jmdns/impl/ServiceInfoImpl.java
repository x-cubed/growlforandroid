 ...
 * 
 * Modified by Carey:
 * - Removed @Overrides on interface implementations to build for Android
 * - Don't convert the service name to lower case, as it's displayed in the Growl UI
 */
public class ServiceInfoImpl extends ServiceInfo implements DNSListener, Cloneable, DNSStatefulObject
{
    ...
    {
        return (_name != null ? _name + "." : "") + (_type != null ? _type.toLowerCase() : "");
    }
